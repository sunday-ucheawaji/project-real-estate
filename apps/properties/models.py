...
class PropertyPublishedManager(models.Manager):
    ...
    def get_queryset(self):
        return (
            super(PropertyPublishedManager, self).get_queryset().filter
...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(verbose_name=_("Description"), 
                                   default="Default description ... update please")
    country = CountryField(verbose_name=_("Country"), default="NG", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Lekki")
    ...
    plot_area = models.DecimalField(verbose_name=_("Plot Area(m^2)"), max_digits=8, 
    ...
    advert_type = models.CharField(verbose_name=_("Advert Type"), max_length=50, 
    ...
    cover_photo = models.ImageField(verbose_name=_("Main Photo"), default="/house_sample.jpg", 
